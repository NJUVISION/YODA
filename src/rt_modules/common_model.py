...
from src.rt_modules.layers.cuda_inference import combine_for_reading_2x, \
...
class CompressionModel(nn.Module):
    def __init__(self, z_channel, extra_qp=0):
        ...
        self.bit_estimator_z = BitEstimator(1 + extra_qp, z_channel)
    ...
    def get_qp(self, qp_list, q_scale_model):
    ...
    def forward_prior_4x(self, y, common_params, 
                          y_spatial_prior_adaptor_1, y_spatial_prior_adaptor_2,
                          y_spatial_prior_adaptor_3, y_spatial_prior, y_spatial_prior_reduction =None, write =False):
        '''
        y_0 means split in channel, the 0/4 quater
        y_1 means split in channel, the 1/4 quater
        y_2 means split in channel, the 2/4 quater
